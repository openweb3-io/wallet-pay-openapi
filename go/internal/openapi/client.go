...
// APIClient manages communication with the Wallet-Pay API Documentations API v1.0
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RateApi = (*RateApiService)(&c.common)
...
func (c *APIClient) callAPI(request *http.Request) (*http.Response, error) {
	...
	for try := 0; try < NumTries; try++ {
		...
		retryCount++
		request.Header.Set("walletpay-retry-count", strconv.Itoa(retryCount))
